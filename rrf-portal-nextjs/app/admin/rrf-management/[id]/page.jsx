  ...
  const handleConfirmAction = async () => {
    ...
    try {
      ...
      if (modalType === 'approve') {
        ...
        await rrfApi.fillByBench(rrfId, `Internal RRF: ${internalRrfNumber}, Candidate: ${candidateName}, DOJ: ${dateOfJoining}`)
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      disabled={isSubmitting}
                    />
                    <p className="text-xs text-slate-500 mt-1">Format: IN-RRF-XXX</p>
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-2">
                      Candidate Name *
