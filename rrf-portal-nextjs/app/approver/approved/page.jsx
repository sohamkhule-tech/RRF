...
export default function ApproverApprovedPage() {
  ...
  // Fetch approved RRFs from backend
  const { requests, loading, error, refresh } = useApproverRequests('approved')
  ...
  return (
    <ProtectedRoute requiredPermission={PERMISSIONS.APPROVALS.READ}>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 px-5 py-3 bg-white border-2 border-green-200 rounded-xl shadow-md">
